...
static void FlushDataCache(Service::Interface* self) {
    ...
    VideoCore::g_renderer->NotifyFlush(false, Memory::VirtualToPhysicalAddress(address), size);
...
static void ExecuteCommand(const Command& command, u32 thread_id) {
    ...
    case CommandId::REQUEST_DMA:
        ...
        VideoCore::g_renderer->NotifyFlush(true, Memory::VirtualToPhysicalAddress(command.dma_request.dest_address), command.dma_request.size);
    ...
    case CommandId::SET_COMMAND_LIST_LAST:
    {
        ...
        VideoCore::g_renderer->NotifyFlush(true, Memory::VirtualToPhysicalAddress(params.address), params.size);
    ...
    case CommandId::SET_MEMORY_FILL:
    {
        ...
        if (params.control1 & 0x1) {
            VideoCore::g_renderer->NotifyFlush(true, Memory::VirtualToPhysicalAddress(params.start1), params.end1 - params.start1);
        }

        if (params.control2 & 0x1) {
            VideoCore::g_renderer->NotifyFlush(true, Memory::VirtualToPhysicalAddress(params.start2), params.end2 - params.start2);
        }
    ...
    case CommandId::SET_DISPLAY_TRANSFER:
    {
        ...
        VideoCore::g_renderer->NotifyPreDisplayTransfer(params.in_buffer_address, params.out_buffer_address);
        ...
        VideoCore::g_renderer->NotifyFlush(true, Memory::VirtualToPhysicalAddress(params.out_buffer_address), params.out_buffer_size);
