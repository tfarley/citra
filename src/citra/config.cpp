...
void Config::ReadValues() {
    ...
    Settings::values.use_hw_vertex_shaders = glfw_config->GetBoolean("Renderer", "use_hw_vertex_shaders", false);
    Settings::values.use_high_res = glfw_config->GetBoolean("Renderer", "use_high_res", false);
